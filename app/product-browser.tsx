...
type LocalisationKey = "EU" | "UK" | "US" | "Japan";
...
const localisationOptions: Array<{ key: LocalisationKey; value: Localisation }> = [
    {key: "EU", value: {label: "EU", currency: "EUR", locale: "en-IE", rateFromUsd: 0.92}},
    {key: "UK", value: {label: "UK", currency: "GBP", locale: "en-GB", rateFromUsd: 0.79}},
    {key: "US", value: {label: "US", currency: "USD", locale: "en-US", rateFromUsd: 1.0}},
    {key: "Japan", value: {label: "Japan", currency: "JPY", locale: "ja-JP", rateFromUsd: 155}},
];

const localisations: Record<LocalisationKey, Localisation> = localisationOptions.reduce(
    (acc, option) => {
            ...
            <main className="mx-auto flex min-h-screen w-full max-w-[1600px] flex-col px-6 py-6 lg:px-8">
                <section className="mt-6 grid gap-6 xl:grid-cols-[280px_minmax(0,1fr)_320px]">
                    ...
                    <section
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <h2 className="mt-1 text-xl font-semibold">
                                    Recommended for procurement teams in the {localisation.label}
                                </h2>
                            </div>
                            ...
                            <div className="grid gap-3 sm:grid-cols-3">
                                <div
                                    ...
                                    <div className="mt-1 text-sm font-medium">Localised</div>
                                </div>
                                <div
                                    className="rounded-2xl border border-zinc-200 bg-zinc-50 px-4 py-3 dark:border-zinc-800 dark:bg-zinc-950">
                                    <div className="text-xs uppercase tracking-wide text-zinc-500 dark:text-zinc-400">
                        ...
                        <div className="mt-5 flex flex-wrap items-center justify-between gap-3 text-sm">
                            ...
                            <label className="flex items-center gap-2 text-zinc-500 dark:text-zinc-400">
                                ...
                                <select
                                    ...
                                    onChange={(event) => setLocalisationKey(event.target.value as LocalisationKey)}
                                ...
                                >
                                    {localisationOptions.map(({key, value}) => (
                        ...
                        <div
                            className="mt-5 flex items-center justify-between border-b border-zinc-200 pb-5 dark:border-zinc-800">
                            <div className="text-sm text-zinc-500 dark:text-zinc-400">
                                            ...
                                            <div
                                                ...
                                                <div className="rounded-2xl bg-zinc-50 px-4 py-3 dark:bg-zinc-950">
                                                    ...
                                                    <div className="mt-1 text-sm font-semibold">
                                                        {formatPrice(product.basePrice, localisation)}
                                                    </div>
                                                </div>
                                                <div className="rounded-2xl bg-zinc-50 px-4 py-3 dark:bg-zinc-950">
                                                    <div
